...
CREATE TABLE IF NOT EXISTS `playlists` (
  ...
  `tags` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Comma-separated playlist tags',
  `description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Playlist description',
...
-- ============================================
-- Create schema_version table if it doesn't exist (from previous migrations)
